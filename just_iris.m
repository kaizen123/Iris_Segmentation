...
rows = length(image(:,1));      %% Cantidad de filas
cols = length(image(1,:));      %% Cantidad de columnas
...
iris(1:rows, 1:col_1) = 0;
iris(1:rows, col_2:cols) = 0;
iris(1:row_1, col_1:col_2) = 0;
iris(row_2:rows, col_1:col_2) =0;
